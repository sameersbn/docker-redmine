...
```bash
docker pull quay.io/sameersbn/redmine:2.6.7-1
```
...
docker run --name=postgresql-redmine -d \
  ...
  quay.io/sameersbn/postgresql:9.4-4
```
...
docker run --name=redmine -d \
  ...
  quay.io/sameersbn/redmine:2.6.7-1
```
...
```bash
docker pull quay.io/sameersbn/postgresql:9.4-4
```
...
```bash
docker run --name=redmine -d [OPTIONS] quay.io/sameersbn/redmine:2.6.7-1
```
...
docker run --name=redmine -d [OPTIONS] \
  quay.io/sameersbn/redmine:2.6.7-1 app:rake redmine:email:test[admin]
```
...
```bash
docker run --name=redmine -d [OPTIONS] \
  quay.io/sameersbn/redmine:2.6.7-1 app:rake redmine:attachments:prune
```
