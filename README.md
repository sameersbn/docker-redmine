...
```bash
docker pull sameersbn/redmine:2.6.3
```
...
docker run --name=redmine -it --rm \
  -v /opt/redmine/data:/home/redmine/data sameersbn/redmine:2.6.3
```
...
```bash
docker run --name=redmine -d [OPTIONS] sameersbn/redmine:2.6.3
```
